...
touch_sensor=8  # Define the pin number to which the sensor is connected
...
while True:   # Execute the following commands in an infinite loop
    if GPIO.input(touch_sensor):    # GPIO.input(touch_sensor)will return the state of GPIO and judge, if GPIO8 is high (i.e. The sensor received signal)
